        ...
        <form @submit.prevent="submit">
            <div class="flex flex-col p-2 justify-start">
                ...
                <input type="text" name="title" v-model="title" required autocomplete="off"
                    placeholder="Digite o título da aula..." class="text-white p-2 w-4/5 rounded-2xl border min-w-full border-gray-200">
            </div>
            <div class="flex flex-col p-2">
                ...
                <input type="text" name="description" v-model="description" required autocomplete="off"
                    placeholder="Digite a descrição da aula..." class="text-white p-2 w-4/5 rounded-2xl border min-w-full border-gray-200">
            </div>
            <div class="flex flex-col p-2">
                ...
                <input type="text" name="category" v-model="category" required autocomplete="off"
                    placeholder="Digite a categoria da aula..." class="text-white p-2 w-4/5 rounded-2xl border min-w-full border-gray-200">
            </div>
            <div class="flex flex-col p-2">
                ...
                <input type="text" name="link" v-model="link" required autocomplete="off"
                    placeholder="Digite o link da aula..." class="text-white p-2 w-4/5 rounded-2xl border min-w-full border-gray-200">
            </div>
            <div class="flex flex-col p-2">
                ...
                <input type="text" name="image" v-model="image" required autocomplete="off"
                    placeholder="Digite o link da imagem da aula..." class="text-white p-2 w-4/5 rounded-2xl border min-w-full border-gray-200">
            </div>
