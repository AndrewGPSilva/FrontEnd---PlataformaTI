    ...
    <section class="mt-8">
        <ul class="flex flex-col">
            ...
            <div class="flex justify-around mb-3">
                <li><a href="https://github.com/AndrewGPSilva" target="_blank"><i class="pi pi-github" style="font-size: 2.5rem; color: rgb(77, 77, 77)"></i></a></li>
                <li><a href="https://www.instagram.com/andrew_gpereira/" target="_blank"><i class="pi pi-instagram" style="font-size: 2.5rem; color: rgb(77, 77, 77)"></i></a></li>
                <li><a href="https://twitter.com/AndrewGPS13" target="_blank"><i class="pi pi-twitter" style="font-size: 2.5rem; color: rgb(77, 77, 77)"></i></a></li>
            </div>
        </ul>
    </section>
</template>
